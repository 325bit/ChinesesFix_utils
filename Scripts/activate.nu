...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\FileSaves\PyCharm Projects\ChinesesFix_utils'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\FileSaves\PyCharm Projects\ChinesesFix_utils\Scripts\deactivate.nu'
